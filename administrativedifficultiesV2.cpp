        ...
        while(m--){
            ...
            if (event=="p"){
                ...
                if (carIn.find(car)==carIn.end() && carOut.find(car)!=carOut.end()){
                    ...
                    //inconsistent case!
                    bill[spy]=INT_MIN; //if -1, means inconsistent
